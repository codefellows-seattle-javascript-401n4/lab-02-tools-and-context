...
fp.spliceCall = function(start, num){
  return Array.prototype.splice.call(start, num);
};

fp.spliceApply = function(start, num){
  return Array.prototype.splice.apply(start, [num]);
};

fp.spliceBind = function(start, num){
  return function(){
    return Array.prototype.splice.call(this.start, this.num);
  }.bind({start:start,num:num})();
};
